...
const LabourTab: React.FC<Props> = ({ workspaceId, onRefreshSummary }) => {
    ...
    return (
        <div>
            <div style={{ marginBottom: 16 }}>
                <button onClick={() => { setForm({}); setIsModalVisible(true); }} className="execution-secondary-button"><Plus size={16} /> Record Labour</button>
            </div>
            {loading ? <p>Loading...</p> : (
