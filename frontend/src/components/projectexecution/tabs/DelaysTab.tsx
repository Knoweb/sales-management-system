...
const DelaysTab: React.FC<Props> = ({ workspaceId, onRefreshSummary }) => {
    ...
    return (
        <div>
            <div style={{ marginBottom: 16 }}>
                <button onClick={() => { setForm({}); setIsModalVisible(true); }} className="execution-secondary-button"><Plus size={16} /> Report Delay</button>
            </div>
            {loading ? <p>Loading...</p> : (
